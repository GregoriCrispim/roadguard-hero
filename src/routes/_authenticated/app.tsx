  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border bg-card p-6">
        ...
        {!reports?.length && <p className="mt-3 text-sm text-muted-foreground">Você ainda não fez reportes. <Link to="/reportar" className="text-primary underline">Comece agora.</Link></p>}
